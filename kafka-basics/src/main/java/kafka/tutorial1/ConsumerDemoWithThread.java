...
public class ConsumerDemoWithThread {
    ...
    public class ConsumerRunnable implements Runnable {
        ...
        public ConsumerRunnable(String bootstrapServers, String groupId, String topic, String offsetResets, CountDownLatch latch) {
            this.latch = latch;
            ...
            consumer.subscribe(Collections.singleton(topic)); //Array.asList(topic1, topic2 ...)
        }
